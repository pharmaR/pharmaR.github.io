...
![Figure 1. Global R library update and package qualification workflow diagram](Images/Merck_1.PNG)
...
![Figure 2. GGally dry run installation log snippet.](Images/Merck_2.PNG)

4.  Check package code coverage and associated SDLC documentation (criterion c2) (Figure 3, Figure 4):

![Figure 3. Code coverage statistics of GGally obtained from internal RSPM server.](Images/Merck_3.PNG)

![Figure 4. GGally SDLC documentation from CRAN.](Images/Merck_4.PNG)
