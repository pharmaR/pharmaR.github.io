...
<div class="ready col-sm-4 text-center pointer" onclick="window.open('https://slack.r-consortium.org');">
<div>
...
<div class="ready col-sm-4 text-center pointer" onclick="window.open('https://lists.r-consortium.org/g/RConsortium-Validation-Hub')">
<div>
...
<div class="ready col-sm-4 text-center pointer" onclick="">
<div>
Donate<br>
