...
*If you are interested in getting involved in contributing to our technical efforts then please send an email to [psi.aims.r.validation@gmail.com](mailto:psi.aims.r.validation@gmail.com).  Or join our [mailing list](https://www.pharmar.org/contact/) to receive an invite to our community meetings and receive notifications of new blog posts.*
