...
<<<<<<< HEAD
Then, the information is scored in order to estimate associated risk. This final score converts the assessment value into a single numeric score between 0 (poor) and 1 (great). Finally each package’s risk is summarized as a weighted sum of assessment scores.
=======
...
>>>>>>> cced8db059a91c3cdad965abd95458d79daaa70f
