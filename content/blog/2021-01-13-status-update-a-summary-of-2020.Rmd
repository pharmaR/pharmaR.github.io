...
In 2020, we continued to develop the riskmetric package (https://github.com/pharmaR/riskmetric) and began to align development with the Risk Assessment Shiny app (see below).  We provided a workshop to guide users to implement a risk-based approach to qualify R packages in R/Pharma conference (https://github.com/pharmaR/rpharma2020). The team is targeting to release the first version of riskmetric package to CRAN in early 2021.
